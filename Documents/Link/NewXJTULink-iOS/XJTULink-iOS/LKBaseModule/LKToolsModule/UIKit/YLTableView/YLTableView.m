...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    YLTableViewSection *section = self.visibleSections[indexPath.section];
    [section configCell:cell forRowIndex:indexPath.row];
    
    if ([self.yl_delegate respondsToSelector:@selector(yl_tableView:configCell:atIndexPath:section:)]) {
        [self.yl_delegate yl_tableView:self configCell:cell atIndexPath:indexPath section:section];
    }
